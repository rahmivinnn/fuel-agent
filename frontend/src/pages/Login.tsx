        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-12 rounded-[30px] border-2 border-gray-300 bg-white hover:bg-gray-50 text-gray-700 font-['Poppins'] shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-[1.02]"
            ...
            >
              ...
              {googleLoading ? "Signing in..." : `Continue with Google (${platform})`}
            </Button>
          </form>
        </Form>
